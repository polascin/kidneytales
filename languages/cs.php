...
return [
    ...
    'username_help' => 'Pouze písmena, čísla a podtržítka. Minimálně 3 znaky.',
    'password_requirements' => 'Minimálně 8 znaků',
    'passwords_must_match' => 'Hesla se musí shodovat',
    'login_description' => 'Přihlásit se ke svému účtu Ledvinové příběhy',
    'register_description' => 'Vytvořit svůj účet Ledvinové příběhy',
    'back_to_home' => 'Zpět domů',
    'sign_in' => 'Přihlásit se',
    'sign_up_here' => 'Registrovat se zde',
    'remember_me' => 'Zapamatovat si mě',
    'no_account' => 'Nemáte účet?',
    'please_fill_required_fields' => 'Prosím vyplňte všechna povinná pole.',
    'invalid_csrf_token' => 'Neplatný bezpečnostní token. Zkuste to prosím znovu.',
