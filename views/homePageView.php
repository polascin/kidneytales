...
<head>
  ...
  <title><?= isset($t['app_name']) ? htmlspecialchars($t['app_name']) : 'Kidney Tales'; ?></title>
  <!-- Favicon -->
  ...
  <meta name="application-name" content="<?= isset($t['app_name']) ? htmlspecialchars($t['app_name']) : 'Kidney Tales'; ?>">
  ...
  <!-- Google Fonts: Roboto and Segoe UI (fallback) -->
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Fira+Mono:wght@400;700&display=swap" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Segoe+UI:wght@400;700&display=swap" rel="stylesheet">
  <!-- CSS Stylesheets -->
  <link rel="stylesheet" href="/css/reset.css?v=<?= time() ?>">
  <link rel="stylesheet" href="/css/colorStyle.css?v=<?= time() ?>">
  <link rel="stylesheet" href="/css/basicFontStyle.css?v=<?= time() ?>">
  <link rel="stylesheet" href="/css/basicStyle.css?v=<?= time() ?>">
</head>
