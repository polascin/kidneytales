...
require_once APP_ROOT . DS . 'resources' . DS . 'views' . DS . 'components' . DS . 'body.php';
require_once APP_ROOT . DS . 'resources' . DS . 'views' . DS . 'components' . DS . 'language-selector.php';
require_once APP_ROOT . DS . 'resources' . DS . 'views' . DS . 'components' . DS . 'header.php';
require_once APP_ROOT . DS . 'resources' . DS . 'views' . DS . 'components' . DS . 'main-content.php';
